...
## After App Academy
  ...
  In addition to crafting a custom website for <a target='_blank' href='https://nickgentrybjj.github.io/CalAutoTech/'>Cal Auto Tech</a>, I was also hired to develop an online platform for a local emerging band, <a target='_blank' href='https://luvsikangel.com'>LuvSikAngel</a>. Currently, I'm in the process of refactoring the LuvSikAngel website to TypeScript, aimed at enhancing code quality, improving maintainability, and leveraging TypeScript's robust type system for better development efficiency.  Check out the <a target="_blank" href="https://github.com/NickGentryBJJ/LuvSikReact">git repository<a/> to see the progress!
